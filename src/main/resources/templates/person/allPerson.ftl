...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <button id="add" class="layui-btn  layui-btn-sm" data-type="add" type="submit" lay-event="add">添加</button>
    </div>
</script>
...
<script src="/static/scripts/myjs/personJs/allPerson.js"></script>
</body>
</html>